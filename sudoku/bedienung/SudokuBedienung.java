...
//		Thread.sleep(10);
	 ...
	 * @param alle bei true wird ein Eintrag in alle klaren Felder gesetzt, bei false nur in das erste (beste) logisch erkannte Feld.
...
//			auffrischen( true);  // mit Anzeige
	 ...
	 */
	public InfoSudoku gibNeues(NeuTyp neuTyp, NeuTypOption option, 
			InfoSudoku vorlage, FortschrittAnzeige fortschrittAnzeige){
