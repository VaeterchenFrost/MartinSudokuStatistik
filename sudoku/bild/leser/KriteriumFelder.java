...
class KriteriumFelder implements KriteriumBildInfo {
	 ...
	 *            Bei diesem Wert, der kleiner als der Sollwert ist, ist das
	 *            Kriterium zu 0 Prozent erf�llt, also nicht erf�llt.
	 * @param erfuellung0Max
	 *            Bei diesem Wert, der gr��er als der Sollwert ist, ist das
	 *            Kriterium zu 0 Prozent erf�llt, also nicht erf�llt.
	 ...
	 * @param name
	 * @param vonFeld
	 *            Benennung des Bereichs: Feld oben links
	 * @param bisFeld
	 *            Benennung des Bereichs: Feld unten rechts
	 * @param sollSchwarz
	 * @param erfuellung0Min
	 * @param erfuellung0Max
	 */
