...
class BasisKriterium {
	...
	static public KriteriumBildInfo waagerechterStrich4(){
		KriteriumFelder kriterium1 = new KriteriumFelder("Schwarz Zeile 4", schwarzAb70, new FeldNummer(1,4), new FeldNummer(6, 4));
		KriteriumFelder kriterium2 = new KriteriumFelder("Schwarz Zeile 5", schwarzAb70, new FeldNummer(1,5), new FeldNummer(6, 5));
	...
	static public KriteriumBildInfo grosserKreisOben9(){
		return new KriteriumFelder("Groﬂer Kreis oben", schwarzAb80, new FeldNummer[]{
				new FeldNummer(2,1), new FeldNummer(3,1), new FeldNummer(4,1), new FeldNummer(5, 1),
				new FeldNummer(1,2), new FeldNummer(6,2),
				new FeldNummer(1,3), new FeldNummer(6,3),
				new FeldNummer(2,4), new FeldNummer(3,4), new FeldNummer(4,4), new FeldNummer(5, 4),
		});
	}

	static public KriteriumBildInfo grosserKreisUnten68(){
		return new KriteriumFelder("Groﬂer Kreis unten", schwarzAb80, new FeldNummer[]{
				new FeldNummer(2,3), new FeldNummer(3,3), new FeldNummer(4,3), new FeldNummer(5, 3),
				new FeldNummer(1,4), new FeldNummer(6,4),
				new FeldNummer(1,5), new FeldNummer(6,5),
	...
	static public KriteriumBildInfo grosserKreisUntenOffen35(){
		return new KriteriumFelder("Groﬂer Kreis unten offen", schwarzAb80, new FeldNummer[]{
				new FeldNummer(4,3), new FeldNummer(5, 3),
				new FeldNummer(6,4),
				new FeldNummer(1,5), new FeldNummer(6,5),
				new FeldNummer(2,6), new FeldNummer(3,6), new FeldNummer(4,6), new FeldNummer(5, 6),
		});
	...
	static public KriteriumBildInfo grosserHalbkreisOben26(){
		return new KriteriumFelder("Groﬂer Halbkreis oben", schwarzAb80, new FeldNummer[]{
				new FeldNummer(2,1), new FeldNummer(3,1), new FeldNummer(4,1), new FeldNummer(5, 1),
				new FeldNummer(1,2), new FeldNummer(6,2)});
	}

	static public KriteriumBildInfo kleinerKreisOben3(){
		return new KriteriumFelder("Kleiner Kreis oben", schwarzAb80, new FeldNummer[]{
				new FeldNummer(2,1), new FeldNummer(3,1), new FeldNummer(4,1), 
				new FeldNummer(1,2), new FeldNummer(5,2),
				new FeldNummer(5,3)
		});
	}
	...
	static public KriteriumBildInfo kleinerKreisOben8(){
		return new KriteriumFelder("Kleiner Kreis oben", schwarzAb80, new FeldNummer[]{
				new FeldNummer(2,1), new FeldNummer(3,1), new FeldNummer(4,1), new FeldNummer(5,1), 
				new FeldNummer(2,2), new FeldNummer(5,2),
				new FeldNummer(2,3), new FeldNummer(5,3)
		});
	}
	...
	static public KriteriumBildInfo ausgangLinks2(){ 
		return new KriteriumFelder("Weiﬂ Links oben", weiss, new FeldNummer[]{
				new FeldNummer(1,3), new FeldNummer(2,3), new FeldNummer(1,4)});
	}
	...
	static public KriteriumBildInfo ausgangLinks7(){ 
		return new KriteriumFelder("Weiﬂ Links", weiss, new FeldNummer[]{
				new FeldNummer(1,2), new FeldNummer(2,2), new FeldNummer(3,2),
	...
	static public KriteriumBildInfo ausgangRechtsUnten2(){
		return new KriteriumFelder("Weiﬂ Rechts unten", weiss, new FeldNummer[]{
				new FeldNummer(6,4), new FeldNummer(5,5), new FeldNummer(6,5)});
	}
