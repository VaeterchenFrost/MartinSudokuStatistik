...
public class ZahlLeser {
	 ...
	 */
	static private KriteriumZahl_BildInfo[] kriterienBildInfo = {
		new KriteriumZahl1(), 
		new KriteriumZahl4(), 
		new KriteriumZahl7()
	}; 
	 ...
	 */
	static private KriteriumZahl_PerAusgang[] kriterienAusgang = {
		new KriteriumZahl2(), 
		new KriteriumZahl3(), 
		new KriteriumZahl5(), 
		new KriteriumZahl6(), 
	...
	private ArrayList<ZahlErgebnis> gibZahlIntern(ZahlBildInfo zahlBildInfo){
		...
		for(KriteriumZahl_BildInfo zahlKriterium: kriterienBildInfo){
			...
			if (istSystemOutZahl){
				System.out.println(String.format("Zahl %d Kriterien (%s.gibZahlIntern()", 
						zahl, getClass().getName()));
			}
