...
/**
 * @author heroe Die Bereiche innerhalb des Zahl-Rechtecks
 */
...
class ZahlBereiche extends HashMap<FeldNummer, Rectangle> {
	 ...
	 * @param laengeGesamt
	 * @param nBereiche
	 * @return M�glichst gleichm��ig auf die Gesamtl�nge aufgeteilte Bereiche
	 */
	private int[] gibLaengen(int laengeGesamt, int nBereiche) {
		...
		// Rest aufteilen auf die �u�eren Rechtecke
		int rest2 = rest / 2;
	 ...
	 * @param laengen
	 * @param n
	 *            Anzahl der zu summierenden Werte
	 * @return
	 */
