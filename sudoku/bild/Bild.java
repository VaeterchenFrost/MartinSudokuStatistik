...
/**
 * @author heroe Routinen zur Arbeit mit einem Bild (Image)
 */
public class Bild {
	...
	/**
	 * @param src
	 *            Quell-Bild, dass grau oder schwarz/weiss sein kann oder
	 *            sonstwie
	 * @param schwarzWeissGrenze
	...
	public static BufferedImage schwarzWeissAusGrau(BufferedImage grauBild, byte schwarzWeissGrenze) {
		...
		Color grenzColor = new Color(schwarzWeissGrenze, schwarzWeissGrenze, schwarzWeissGrenze); // ,
																									// 255);
