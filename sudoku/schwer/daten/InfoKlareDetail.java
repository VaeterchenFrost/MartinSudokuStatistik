...
public class InfoKlareDetail implements AnzeigeInfo{
	...
	public InfoKlareDetail(int durchLauf, ArrayList<BE_Logik> logikEintraege, 
			int nFreieFelder, int nFreieZeilen, int nFreieSpalten, int nFreieKaesten) {
...
//		}
		...
		String s = String.format("[%s]    %s: %s", 
				gibZahlTextPerUnterstrich(nFreieFelder, 2),
				gibZahlTextPerUnterstrich(anzahlGesetzteEintraege, 2), 
				sLogikAnzahlen); 
		return s;
	}
	...
	public static String[] gibAnzeigeTextBeschreibung() {
		String[] texte = {
		"Anzeige der Logik-Details:",
		"[fF]   X: nxO1",
		"fF   ---> Anzahl freier Felder",
		"X    ---> Anzahl gesetze Zahlen (Einträge)",
		"n   ---> Anzahl der Nutzung der Logik",
	...
	public String gibToolTip() {
		String s1 = String.format("%2d neue eingetragene Zahlen im Logiklauf %d", 
				gibAnzahlGesetzteEintraege(), this.durchLauf);
	...
	public String toString() {
		return "InfoKlareDetail [anzahlGesetzteEintraege=" + gibAnzahlGesetzteEintraege() + ", durchLauf=" + durchLauf
				+ ", erfolgreicheLogiken=" + gibErfolgreicheLogiken() + ", gruppenTypen=" + gibOrtFest1GruppenTypZeichen() 
				+ ", nFreieFelder=" + nFreieFelder + ", nFreieZeilen=" + nFreieZeilen + ", nFreieSpalten=" + nFreieSpalten
				+ ", nFreieKaesten=" + nFreieKaesten + "]";
	}
	
	public void systemOut(int index){
		System.out.println("InfoKlareDetail [" + index + "]: Lauf=" + durchLauf 
				+ " nF=" + nFreieFelder + ", nZ=" + nFreieZeilen + ", nS=" + nFreieSpalten + ", nK=" + nFreieKaesten);
