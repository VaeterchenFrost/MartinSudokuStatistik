...
public class LogikAnzahlen {
	...
	/**
	 * @param logik
	 *            F�r diese Logik wird die Anzahl um 1 vergr��ert
	 */
	...
	/**
	 * @param andere
	 *            Dessen Anzahlen werden zu meinen hinzuaddiert
	 */
	...
	/**
	 * @return Die gr��te Logik mit Anzahl>0
	 */
	...
	/**
	 * @param logikAnzahlFormatierer
	 *            wenn hier null kommt erfolgt Standardformatierung:
	 *            Logik-Kurzname + "=" + anzahl + " ". Im Beispiel "O1=13 "
	 * @return String mit allen LogikAnzahlen ab der gr��ten Logik bis zur
	 *         kleinsten.
	 */
