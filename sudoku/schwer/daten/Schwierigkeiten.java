...
public class Schwierigkeiten implements LangerProzess {
	 ...
	 *         muss als erstes eine Zahl beinhalten f�r die
	...
	private static void schreibeZeiten(String nameVerzeichnis, String[] dateiNamen, boolean mitDetails,
		...
		if ((!mitDetails) & (!infoTexte.isEmpty())) {
			// Schwierigkeiten-�bersicht in der Datei ablegen
			...
			try {
				...
				e.printStackTrace();
				String msg = String.format("Die Datei %s konnte nicht ordungsgem�� erstellt werden", speicherDateiName);
