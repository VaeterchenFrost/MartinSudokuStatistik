...
//		Animator symmetrierer = null;
		...
		if (istSystemOut()) {
			String sErgebnis = ergebnis.infoSudoku == null ? "null" : " Sudoku mit " + ergebnis.infoSudoku.gibAnzahlVorgaben() + " Vorgaben";
	 ...
	 * @throws Exc 
	 */
	static private FeldNummerListe loesche(FeldMatrix feldMatrix, FeldNummerListe vorgaben, int anzahl, Animator symmetrierer) throws Exc {
	 ...
	 * @throws Exc
	 */
	static private FeldNummerListe loesche1Vorgabe(FeldMatrix feldMatrix, FeldNummerListe vorgaben, Animator symmetrierer) throws Exc {
	...
	private GeneratorErgebnis gibNeues(Animator symmetrierer) {
		...
		if (istSystemOut()) {
			...
			System.out.println(String.format("%s.gibNeuesSudoku() %s: Ende %s", 
