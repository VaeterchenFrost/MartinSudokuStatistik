...
public class Zufall {
	 ...
	 *            Fall werden jeweils 2 Vorgaben gel�scht, falls noch 2 Vorgaben
	 *            zur Verf�gung stehen!
	 * @return Zuf�llig ausgew�hlte Felder, deren Anzahl kleiner als die
	 *         vorgegebene Anzahl sein kann
	 */
