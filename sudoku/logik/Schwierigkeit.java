...
public enum Schwierigkeit {
	...
	/**
	 * @param logik
	 *            bei null kommt die kleinste Schwierigkeit zur�ck
	...
	/**
	 * @param typ
	 * @return Gibt einen um eins leichteren Schwierigkeit zur�ck oder null
	 */
	...
	/**
	 * @param typ
	 * @return Gibt einen um eins schwereren Schwierigkeit zur�ck oder null
	 */
	...
	/**
	 * @param klugheit
	 * @return null oder Schwierigkeit, die mit der �bergebenen Klugheit zu
	 *         bew�ltigen ist
	 */
	...
	/**
	 * @return Welche Schwierigkeit welche <code>Klugheit<code> besitzt bzw.
	 *         welche Logiken beherrscht.
	 * @see Klugheit(LogikID maxLogik): Die Klugheit beherrscht maxLogik und
	 *      alle kleineren Logiken von maxLogik!
	 */
