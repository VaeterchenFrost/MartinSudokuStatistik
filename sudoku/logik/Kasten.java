...
public class Kasten extends Gruppe {
	...
	public static FeldNummerListe gibKastenFeldNummern(KastenIndex kastenIndex) throws Exc{
		if ( ! kastenIndex.istOK()){
			String text = String.format("unbekannter Kasten-Index %s (min=%d, max=%d)"
					, kastenIndex,  0, 2); 
			Exc.ausnahme(text);
		}
	...
	/**
	 * @param feldNummer Nummer eines beliebigen Feldes (des Kastens)
	...
	public static String gibNameVomKastenIndex (KastenIndex kastenIndex){
		...
		case 0: iZeileName = "oben";
			break;
		case 1: iZeileName = "mitte";
			break;
		case 2: iZeileName = "unten";
			break;
		}
		
		String iSpalteName = "";
		switch (kastenIndex.iSpalte) {
		case 0: iSpalteName = "links";
			break;
		case 1: iSpalteName = "mitte";
			break;
		case 2: iSpalteName = "rechts";
			break;
		}
